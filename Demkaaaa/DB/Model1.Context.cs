...
namespace Demkaaaa.DB
{
    ...
    public partial class Entities : DbContext
    {
        ...
        public virtual DbSet<WV_Order> WV_Order { get; set; }
    
        public virtual int Pr_UpdateCost(Nullable<int> idProd)
        {
            var idProdParameter = idProd.HasValue ?
                new ObjectParameter("IdProd", idProd) :
                new ObjectParameter("IdProd", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Pr_UpdateCost", idProdParameter);
        }
